    ...
    <view class="card" style="width: 100%;">
        <view class="card-body">
            <view class="mb-3">
                ...
                <input v-model="form.username" class="form-control" placeholder="admin" />
            </view>
            <view class="mb-4">
                <text class="form-label">密码</text>
                <input v-model="form.password" class="form-control" password placeholder="admin123" />
            </view>
...
import { loginApi } from '@/domains/user';
