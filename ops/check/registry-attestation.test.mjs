  ...
  return {
    ...
    artifacts: {
      ...
      telegramEgress: { image: 'registry.acme.test/booking-preprod/telegram-egress', digest: digest('8'), sbomDigest: digest('9'),
        provenanceDigest: digest('b'), buildInputDigest: digest('f'), baseImage: 'debian:bookworm-20260824-slim', baseImageDigest: digest('c'),
        aptSources: { debianMirror: 'https://deb.debian.org/debian', securityMirror: 'https://deb.debian.org/debian-security' },
        warpPackage: { version: '2026.7.1377.0', sha256: 'e'.repeat(64) } },
